...
/*
 * Documentation:
 * DateRange — https://app.subframe.com/library?component=DateRange_1e287dc1-d342-4941-8fc0-f6ec60d8ec91
 */
    ...
    >
      <div
        className={SubframeUtils.twClassNames(
          "group/949140f1 flex h-8 w-full cursor-pointer items-center gap-1 rounded-md px-3 hover:bg-neutral-100 active:bg-neutral-50 data-[highlighted]:bg-brand-50",
          className
        )}
        ref={ref as any}
      >
        <DateRange.ItemText className="h-auto grow shrink-0 basis-0">
          {children || value}
        </DateRange.ItemText>
        <FeatherCheck className="hidden text-body font-body text-default-font group-hover/949140f1:hidden group-data-[state=checked]/949140f1:inline-flex group-data-[state=checked]/949140f1:text-brand-600" />
      </div>
    </SubframeCore.Select.Item>
  );
});
  ...
  return (
    <SubframeCore.Select.Trigger asChild={true} {...otherProps}>
      ...
      >
        ...
        <DateRange.TriggerValue placeholder={placeholder as string} />
...
const DateRangeRoot = React.forwardRef<HTMLElement, DateRangeRootProps>(
  function DateRangeRoot(
    ...
    return (
      ...
      >
        <div
          className={SubframeUtils.twClassNames(
            "group/1e287dc1 flex cursor-pointer flex-col items-start gap-1",
            className
          )}
          ref={ref as any}
          {...otherProps}
        >
          ...
          <div
            className={SubframeUtils.twClassNames(
              "flex h-8 w-full flex-none flex-col items-start rounded-md border border-solid border-neutral-border bg-default-background group-focus-within/1e287dc1:border group-focus-within/1e287dc1:border-solid group-focus-within/1e287dc1:border-brand-primary",
              {
                "border border-solid border-neutral-100 bg-neutral-100 group-hover/1e287dc1:border group-hover/1e287dc1:border-solid group-hover/1e287dc1:border-neutral-border group-hover/1e287dc1:bg-neutral-100":
                  variant === "filled",
...
export const DateRange = Object.assign(DateRangeRoot, {
  Item,
  TriggerValue,
  Content,
  Trigger,
