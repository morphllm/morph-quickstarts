...
/*
 * Documentation:
 * Select2 — https://app.subframe.com/library?component=Select2_07d5b39a-dd57-4f47-9b88-2a87e1d503e1
 */
    ...
    >
      <div
        className={SubframeUtils.twClassNames(
          "group/42a0e385 flex h-8 w-full cursor-pointer items-center gap-1 rounded-md px-3 hover:bg-neutral-100 active:bg-neutral-50 data-[highlighted]:bg-brand-50",
          className
        )}
        ref={ref as any}
      >
        ...
        <FeatherCheck className="hidden text-body font-body text-default-font group-hover/42a0e385:hidden group-data-[state=checked]/42a0e385:inline-flex group-data-[state=checked]/42a0e385:text-brand-600" />
      </div>
    </SubframeCore.Select.Item>
  );
});
...
const Select2Root = React.forwardRef<HTMLElement, Select2RootProps>(
  function Select2Root(
    ...
    return (
      ...
      >
        <div
          className={SubframeUtils.twClassNames(
            "group/07d5b39a flex cursor-pointer flex-col items-start gap-1",
            className
          )}
          ref={ref as any}
          {...otherProps}
        >
          ...
          <div
            className={SubframeUtils.twClassNames(
              "flex h-8 w-full flex-none flex-col items-start rounded-md border border-solid border-neutral-border bg-default-background group-focus-within/07d5b39a:border group-focus-within/07d5b39a:border-solid group-focus-within/07d5b39a:border-brand-primary",
              {
                "border border-solid border-neutral-100 bg-neutral-100 group-hover/07d5b39a:border group-hover/07d5b39a:border-solid group-hover/07d5b39a:border-neutral-border group-hover/07d5b39a:bg-neutral-100":
                  variant === "filled",
