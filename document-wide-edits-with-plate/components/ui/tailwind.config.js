module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        caption: "var(--font-figtree)",
        "caption-bold": "var(--font-figtree)",
        body: "var(--font-figtree)",
        "body-bold": "var(--font-figtree)",
        "heading-3": "var(--font-figtree)",
        "heading-2": "var(--font-figtree)",
        "heading-1": "var(--font-figtree)",
